...
*/				    
	...
	public void visit(Divide n) {
		...
		String op2 = getExpr(n.e2, false); 
		printInstr("movq", new String[]{"%rax", "%r10"});
		printInstr("cmpq", new String[]{"$0", "%r10"});
		printInstr("jz", new String[]{"noDivide"});
		printInstr("jmp", new String[]{"Divide"});
		System.out.println("Divide :");
		printInstr("movq", new String[]{"%rax","%r10"});
		String op1 = getExpr(n.e1, false); 
		printInstr("cqo");
		printInstr("idivq", new String[]{"%r10"});
		printInstr("jmp", new String[]{"end"});
